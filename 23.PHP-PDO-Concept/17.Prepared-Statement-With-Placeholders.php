...
<?php   
    ...
    try{
        ...
        // defining 'posts' table related some data
        $book_title = 'PHP Fundamentals Learning';
        $author_name = 'Rozlov Ganver';
        $book_description = 'This book is about fundamentals of PHP based concepts';
        $is_published = true;
        // $created_at = mktime();
        ...
        // binding those placeholder/references as an associative array to substitue those values
