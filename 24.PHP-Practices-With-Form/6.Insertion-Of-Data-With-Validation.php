        ...
        <div class="row m-5">
            ...
            <div class="col-8 p-3 border">
                ...
                <form action="<?php $_SERVER['PHP_SELF'] ?>" method="POST">
                    ...
                    <?php
                        // getting the file
                        include_once './validating-data-insertion.php';
                        ...
                        {
                            $errors[] = "Product BarCode is required";
                        }
                    ...
                    <!-- If errors array is not empty then only show the alerts -->
                    <?php if(!empty($errors)) : ?>
                        <div class="alert alert-danger">
                            <?php foreach($errors as $error): ?>
                                <div class="text-white"><?php echo $error; ?></div>
                            <?php endforeach; ?>
                        </div>
                    <?php endif; ?>
