...
<head>
    ...
    <title>fetch() Method To Get an Index Array</title>
</head>
<body>
<?php   
    ...
    try{
        ...
        while ($data = $statement->fetch(PDO::FETCH_NUM)) { // though pass object needs to be converted into array does the assignment
