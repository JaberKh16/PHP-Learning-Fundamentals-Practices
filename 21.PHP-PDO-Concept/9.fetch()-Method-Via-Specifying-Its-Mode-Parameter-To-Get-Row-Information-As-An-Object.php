...
<head>
    ...
    <title>fetch() Method To Get an Object</title>
</head>
<body>
<?php   
    ...
    try{
        ...
        while ($data = $statement->fetch(PDO::FETCH_OBJ)) { // though pass object needs to be converted into array does the assignment
