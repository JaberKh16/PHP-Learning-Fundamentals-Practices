<?php
    /*
        ...
        ================================================
        'require_once' keyword is to include or gets a file from the 
...
<head>
    ...
    <title>Working with 'require_once' keyword</title>
</head>
<body>
    
    <!-- To resolve the issue use 'include_once' -->
    <?php require_once './heading-part/heading-section.php'; ?>
    <!-- To see issue with including even if path doesn't match uncomment the following -->
    <!-- <?php require_once './heading-part/heading-sectionss.php'; ?> -->
    ...
    <?php require_once './footer-part/footer-section.php';  ?>
